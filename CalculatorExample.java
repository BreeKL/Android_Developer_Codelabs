// A simple app page to create a calculator using buttons and click events
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (editText.getText().length() > 0) {
                    ...
                    resultText.setText(editText.getText().toString() + " + ");
        ...
        multiplyButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (editText.getText().length() > 0) {
                    ...
                    resultText.setText(editText.getText().toString() + " X ");
                    // Clear the EditText for the next number
                    editText.setText("");
                }
            }
        ...
        equalButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (editText.getText().length() > 0) {
                    ...
                    if (isAddition) {
                        resultText.setText(resultText.getText().toString() + editText.getText().toString() + " = " + String.valueOf(num1 + num2));
